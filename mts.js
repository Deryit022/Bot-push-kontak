...
case "yaww": {
  ...
  const textcap = `*SERVER BOTS*
  
ʜɪ, 🔍 ${nx.pushName}*
sᴀʏᴀ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ᴏᴛᴏᴍᴀᴛɪs ʏᴀɴɢ ᴀᴋᴀɴ ᴍᴇᴍʙᴀɴᴛᴜ ᴍᴜ ᴛᴜᴀɴ sᴀʏᴀ ᴅɪʙᴜᴀᴛ ᴏʟᴇʜ Fahrii HOSTING ᴅᴇɴɢᴀɴ ᴋɪɴᴇʀᴊᴀ ʏᴀɴɢ ᴛɪɴɢɢɪ ɢᴜɴᴀᴋᴀɴ ʙᴏᴛ ɪɴɪ sᴇᴘᴇʀʟᴜɴʏᴀ ᴊᴀɴɢᴀɴ sᴀᴍᴘᴀɪ ᴍᴇɴɢᴀʟᴀᴍɪ ʙᴏᴛ ɪɴɪ 🍂
 𝐈 𝐍 𝐅 𝐎 - 𝐁 𝐎 𝐓 ⚙️
...
case "savecontactgc": {
  if (!isPremium && !isOwner) {
    ...
    if (!isGroup) {
      return reply("Khusus Dalam Group Yah Bang")
    } else {
